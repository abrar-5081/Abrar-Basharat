...
- Notebooks (per-task, permalinks):
  - Task 1 — Titanic Survival Prediction: codsoft_task_1.ipynb  
    https://github.com/abrar-5081/Abrar-Basharat/blob/main/codsoft_task1.ipynb
  - Task 2 — Movie Rating Prediction: codsoft_task_2.ipynb  
    https://github.com/abrar-5081/Abrar-Basharat/blob/main/codsoft_task2.ipynb
  - Task 3 — Iris Flower Classification: codsoft_task_3.ipynb  
    https://github.com/abrar-5081/Abrar-Basharat/blob/main/codsoft_task3.ipynb
  - Task 4 — Sales Prediction: codsoft_task_4.ipynb  
    https://github.com/abrar-5081/Abrar-Basharat/blob/main/codsoft_task4.ipynb
  - Task 5 — Credit Card Fraud Detection: codsoft_task_5.ipynb  
    https://github.com/abrar-5081/Abrar-Basharat/blob/main/codsoft_task5.ipynb
...
Task 1 — Titanic Survival Prediction
- Notebook: codsoft_task1.ipynb (permalink above)
...
Contact
- For questions about these tasks or notebooks, contact: abrar5081
